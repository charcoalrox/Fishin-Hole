...
void main(void){
    ...
    uint8_t QUACK = 5; //I think this is the length the duck has mouth open while it quacks
    ...
    while(1){
        ...
        if (demoTimer % 4){ //Reusing demo timer to save precious ram space. Think of this like a boatDelayCounter of sorts
            boatPosX += boatDir;
